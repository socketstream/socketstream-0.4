...
/* 
  ...
  Why output to a file? Because Browerify 2 no longer sends the module
...
module.exports = function(app) {
  ...
  buf.push("  app.transport(" + app._transport.client.toString() + ");\n");

  buf.push("  // DEFINE SERVICES");
  for (var id in app._services.services) {
    var service = app._services.services[id];
    buf.push("\n  // " + service.name + " service");
    buf.push("  app.services.register(" + JSON.stringify(service.paramsForClient()) + ", " + service.client.toString() + ");");
  }
