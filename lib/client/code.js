...
ClientCode.prototype.outputInit = function(options) {
  ...
  // Load the first module once all the system code has executed
  if (this.client) output.push("try { require('" + this.client.firstModule + "')() } catch(e) { console.log('SocketStream Error: Unable to find first module to call: " + this.client.firstModule + "') };")
